    ...
    <b-container fluid class="footer">
                ...
                <b-row>
                    ...
                    <b-col lg="4">
                        <b-list-group flush>
                            ...
                            <b-list-group-item href="https://thetokenplant.github.io/erc20-generator/" target="_blank" class="text-warning">
                                Create ERC20 Token
                            </b-list-group-item>
                        </b-list-group>
                    </b-col>
        ...
        <b-modal id="modal-terms"
            ...
            <b-embed
                    type="iframe"
                    aspect="4by3"
                    src="https://thetokenplant.github.io/bep20-generator-terms/"
